...
import demomaster.vo.request.TAuthorRequestUpdateBase;
import demomaster.vo.request.TAuthorRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/TAuthorController")
@Slf4j
public class TAuthorController {

    @Autowired
    private TAuthorService service;
    ...
    public Response insert(@RequestBody TAuthorVo vo) {
    ...
    public Response insert(@RequestBody List<TAuthorVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TAuthorVo query) {
        Response response = new Response();
        try {
            List<TAuthorVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateBase(@RequestBody TAuthorRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody TAuthorRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TAuthorVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(Integer id) {
        Response response = new Response();
        try {
            TAuthorVo result = service.queryByPrimaryKey(id);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody TAuthorRequestUpdatePrimaryKey update) {
        Response response = new Response();
        try {
