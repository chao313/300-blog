...
import demomaster.vo.request.TBlogRequestUpdateBase;
import demomaster.vo.request.TBlogRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/TBlogController")
@Slf4j
public class TBlogController {
    ...
    public Response insert(@RequestBody TBlogVo vo) {
    ...
    public Response insert(@RequestBody List<TBlogVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TBlogVo query) {
        Response response = new Response();
        try {
            List<TBlogVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateBase(@RequestBody TBlogRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody TBlogRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TBlogVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(Integer id) {
        Response response = new Response();
        try {
            TBlogVo result = service.queryByPrimaryKey(id);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody TBlogRequestUpdatePrimaryKey update) {
        Response response = new Response();
        try {
