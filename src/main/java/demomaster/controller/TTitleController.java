...
import demomaster.vo.request.TTitleRequestUpdateBase;
import demomaster.vo.request.TTitleRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/TTitleController")
@Slf4j
public class TTitleController {

    @Autowired
    private TTitleService service;
    ...
    public Response insert(@RequestBody TTitleVo vo) {
    ...
    public Response insert(@RequestBody List<TTitleVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TTitleVo query) {
        Response response = new Response();
        try {
            List<TTitleVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateBase(@RequestBody TTitleRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody TTitleRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TTitleVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(Integer id) {
        Response response = new Response();
        try {
            TTitleVo result = service.queryByPrimaryKey(id);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody TTitleRequestUpdatePrimaryKey update) {
        Response response = new Response();
        try {
