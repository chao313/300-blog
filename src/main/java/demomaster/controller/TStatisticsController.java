...
import demomaster.vo.request.TStatisticsRequestUpdateBase;
import demomaster.vo.request.TStatisticsRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/TStatisticsController")
@Slf4j
public class TStatisticsController {

    @Autowired
    private TStatisticsService service;
    ...
    public Response insert(@RequestBody TStatisticsVo vo) {
    ...
    public Response insert(@RequestBody List<TStatisticsVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TStatisticsVo query) {
        Response response = new Response();
        try {
            List<TStatisticsVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateBase(@RequestBody TStatisticsRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody TStatisticsRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TStatisticsVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(Integer id) {
        Response response = new Response();
        try {
            TStatisticsVo result = service.queryByPrimaryKey(id);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody TStatisticsRequestUpdatePrimaryKey update) {
        Response response = new Response();
        try {
