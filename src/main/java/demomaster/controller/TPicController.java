...
import demomaster.vo.request.TPicRequestUpdateBase;
import demomaster.vo.request.TPicRequestUpdatePrimaryKey;
...
@RestController
@RequestMapping(value = "/TPicController")
@Slf4j
public class TPicController {

    @Autowired
    private TPicService service;
    ...
    public Response insert(@RequestBody TPicVo vo) {
    ...
    public Response insert(@RequestBody List<TPicVo> vos) {
        Response response = new Response();
        try {
    ...
    public Response queryBase(@RequestBody TPicVo query) {
        Response response = new Response();
        try {
            List<TPicVo> result = service.queryBase(query);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateBase(@RequestBody TPicRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response updateBaseIncludeNull(@RequestBody TPicRequestUpdateBase update) {
        Response response = new Response();
        try {
    ...
    public Response deleteBase(@RequestBody TPicVo vo) {
        Response response = new Response();
        try {
    ...
    public Response queryByPrimaryKey(Integer id) {
        Response response = new Response();
        try {
            TPicVo result = service.queryByPrimaryKey(id);
            response.setCode(Code.System.OK);
            response.setContent(result);
            log.info("success result -> {} ", result);
        } catch (Exception e) {
    ...
    public Response updateByPrimaryKey(@RequestBody TPicRequestUpdatePrimaryKey update) {
        Response response = new Response();
        try {
